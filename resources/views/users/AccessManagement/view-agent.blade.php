      ...
      <div class="">
        <div class="col-lg-12">
          <div class="header_view">
            <h2>Helpdesk Agent Detail<small></small></h2>
          </div>
          <div class="col-lg-4">
            <div class="">
              <img alt="" src="{{asset('img/avatar/helpdesk_detail_avatar.png')}}" class="img-responsive" style="margin: auto; width: 100px;">
            </div>
            <div class="uprofile-name">
              <h3>
                <a href="#">{{$data->username}}</a>
              </h3>
              <p class="uprofile-title">Helpdesk Agent</p>
            </div>
          </div>
          <div class="col-lg-8">
            <section class="box ">
