		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" style="text-align: center;color: white">Trader Mobile Number Verification</h4>
				</div>
				<div class="modal-body">
							...
							<form id="add">
								<div class="col-md-3" style="display: inline-block;margin: 0px;padding: 0px;" id="selectBox">
									<select name="mobCode" id="mobCode" class="form-control">
										...
										<option value="92316">0316</option><option value="92317">0317</option><option value="92318">0318</option><option value="92319">0319</option>
					...
					<div class="row" id="codeDIV" style="display: block">
						<div class="col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center text-center code">
							<span style="font-family: serif; font-size: 16px; color:red">Provide Valid Trader Mobile Number for Verification</span>
						</div>
						<div class="form-group">
							<p style="text-align: center;font-size: 16px;color:green;font-weight:900">پی ٹی اے کی  پالیسی کے مطابق اور سیکیورٹی کو محفوظ بنانے کے لیے ٹریڈر کا موباۂل نمبر تصریق ہونا ضروری ہے۔ براۓ مہربانی درست موبائل  نمبر تصریق کریں۔ </p>
						</div> 
					</div>
				</div>
			</div>
