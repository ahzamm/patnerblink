        ...
        <div class="">
          <div class="col-lg-12">
            <div class="header_view">
              <h2>Un-Verified Consumer <small>(Mobile Number)</small></h2>
            </div>
            <section class="box" style="padding:20px; max-width: 900px;margin:auto">
              <header class="panel_header">
                <center>
                  <p style="font-size: 16px;margin-top: 20px"><b style="margin-bottom:10px"><span style="color: red;">NOTE:</span> Enter correct Mobile Number to verify Consumer , in case of any mismatch Consumer will not be verified and you cannot change Consumer profile.</b> <br><br> <b><span style="color: red;">اطلاع:</span> کنزیومر کو تصدیق کرنے کے لیے درست موبائل نمبر درج کریں . بصورت دیگر کنزیومر کی تصدیق نہیں ہوگی اور آپ اپنے کنزیومر کی پروفائل تبدیل نہیں کر سکیں  گے </b></p>
                </center>
              </header>
              <div class="content-body" style="display:flex; justify-content:center;align-item:center;">
                <div>
                  <button class="btn btn-primary" style="font-size:16px;" onclick="showMobileModel(<?php echo $id ?>)" data-toggle="modal"><span class="blink_effect"> Click here to Process <span style="color:yellow">(Consumer)</span> Mobile Number </span></button>
                </div>
              </div>
              <div style="margin-top:20px">
                <p class="text-center" style="padding-bottom:0px">
                  <span class="text-center" style="font-size:18px;background-color: #f44336;color: #fff" id="mobileError">Please verify Computerized National Identity Card (CNIC) first <br/>
                    تصدیق کریں Computerized National Identity Card (CNIC) پہلے کنزیومر کا  
                  </span>
                </p>
              </div>
            </section>
