	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" style="text-align: center;color: white"> Computerized National Identity Card (CNIC) Verification</h4>
			</div>
				...
				<form id="addNic" method="POST">
					...
					<div class="row" id="hmm">
						<div class="form-group">
							<p style="text-align: center;color:green;font-weight:700;font-size: 16px;" >The <span class="text-danger">Computerized National Identity Card (CNIC) VERIFICATION </span> used for active your Recharge process if this Consumer is not verified you cannot recharge this Consumer (ID).</p>
							<p style="text-align: center;color:green;font-weight:900;font-size: 16px;"> براۓ مہربانی کنزیومر  ریچارج کرنے سے پہلے کنزیومر  کا شناسختی کارڈ  تصدیق کریں دوسری صورت میں آپ کنزیومر  کو ریچارج نہیں کر سکتے شکریہ </p>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-11"> 
							<div class="btn-group" role="group" aria-label="Basic example">
								...
								2) &nbsp;
								<input type="radio" name="ptrn" id="2" value="Onic" onchange="changeRadio(this)">
								<label for="2" id="l2" style="margin-right:20px;">
									OverSeas (CNIC)
								</label>
								3) &nbsp;
								...
								4) &nbsp;
								<input type="radio" name="ptrn" value="passport" id="4" onchange="changeRadio(this)">
								<label for="4" id="l4" style="margin-right:20px;">
