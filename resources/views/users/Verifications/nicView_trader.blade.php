...
@endphp
@include('users.Verifications.nicVarification_trader')
        ...
        <div class="">
          <div class="col-lg-12">
            <div class="header_view">
              <h2>VERIFICATION <small>(CNIC Number) Trader</small></h2>
            </div>
            <section class="box" style="padding: 20px;max-width: 900px;margin: auto;">
              <header class="panel_header">
                <center>
                  <p style="font-size: 16px;margin-top:20px;padding:5px"><b><span style="color: red;">NOTE:</span> Registered correct (CNIC) information to verify this Trader, in case of any wrong and mismatch this information otherwise this Trader (ID) will be permanently <span style="color:red">BLOCKED</span>.</b> <br><br> <b><span style="color: red;">اطلاع: </span> ٹریڈر کو تصدیق کرنے کے لئے درست شناختی کارڈ اپ لوڈ کریں- بصورت دیگر ٹریڈر کی تصدیق نہیں ہوگی اور آئی ڈی ہمیشہ کے لئے 
