		...
		<div class="modal-dialog" style="width: 85%">
			<div class="modal-content">
				<div class="modal-header" style="background-color: #4878bf;">
					...
					<h4 class="modal-title" style="text-align: center;color: white"> Mobile Verification</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="col-md-9">		
								<div class="form-group">
									<p style="text-align: center;">As per PTA policy & for security concern , user contact number must be verified.<br>Please type user correct number to verify user.</p><br>
									<p style="text-align: center; ">پی ٹی اے کی  پالیسی کے مطابق اور سیکیورٹی کو محفوظ بنانے کے لیے۔ صارفین کا موباۂل نمبر تصریق ہونا ضروری ہے۔ براۓ مہربانی درست نمبر تصریق کریں۔</p>
								</div>
							</div>
							<div class="col-md-3" id="space"></div>
							<form id="add">
								<div class="col-md-2" style="display: inline-block;margin: 0px;padding: 0px;" id="selectBox">
									<select name="mobCode" id="mobCode" class="form-control">
										...
										<option value="92316">0316</option><option value="92317">0317</option><option value="92318">0318</option>
										<option value="92320">0320</option><option value="92321">0321</option>
										<option value="92322">0322</option><option value="92323">0323</option><option value="92324">0324</option><option value="92330">0330</option>
										...
										<option value="92335">0335</option><option value="92336">0336</option><option value="92337">0337</option><option value="92340">0340</option>
								...
								<div class="col-md-4" style="display: inline-block;margin: 0px;padding: 0px;">
								...
								<form id="addMobileCode" method="POST">
									<div class="form-group" id="codeverify" style="display: none;">
										<div class="input-group"> 
											...
											<input type="text" name="mobileCode" data-mask="LBI-9999" placeholder="9999" class="form-control" required>
											<div class="input-group-btn" id="sendBtn">
												<button type="submit" class="btn btn-primary" style="background-color: #4878C0; color:white;" >
													<span class="glyphicon glyphicon-check"></span> Done Verify
												</button>
											</div>
										</div>
									</div>
						...
						<div class="row" id="codeDIV" style="display: block">
							<div class="col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center text-center" id="code">
								<span style="font-family: serif; font-size: 20px; color:black">Please Enter Valid Mobile Number for Verification</span>
							</div>
						</div>
					</div>
				</div>
	...
	$(document).ready(function(){
		$('#addMobileCode').on('submit', function(event){
			...
			$.ajax({
				...
				{
					if(data == 'false'){
						alert('You enter invalid code');
					}else{
						alert('Your Mobile has been Successfully Registerd');
