  ...
  <section id="main-content">
    <section class="wrapper main-wrapper">
      <div class="header_view">
        <h2>Contractor & Trader Margin Summary
          <span class="info-mark" onmouseenter="popup_function(this, 'contractor_&_trader_margin_summary');" onmouseleave="popover_dismiss();"><i class="las la-info-circle"></i></span>
        </h2>
      </div>
      <?php
      ...
      <section class="box">
        ...
        <div class="content-body">
          <form action="{{route('users.billing.dealersummeryDetail')}}" target="_blank" method="POST">
            @csrf
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="form-group">
                  <label  class="form-label">Select Billing Cycle <span style="color: red">*</span></label>
