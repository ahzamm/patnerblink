		...
		<section class="wrapper main-wrapper row">
			...
			<section class="box ">
				...
				<div class="content-body">
					<div class="row">
						<form action="{{route('users.billing.ledge_PDF')}}" method="POST" target="_blank">
							@csrf
							<div class="col-md-5">
								<div class="form-group">
									<label  class="form-label">Select (Date & Year) Range <span style="color: red">*</span></label>
							...
							<div class="col-md-5">
								<div class="form-group">
									...
									<select class="js-select2" id="username-select" name="username" required >
										...
										@if(Auth::user()->status == "reseller" || Auth::user()->status == "account" || Auth::user()->status == "inhouse")
