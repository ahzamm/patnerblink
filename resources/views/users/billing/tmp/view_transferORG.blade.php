...
<style type="text/css">
	...
	#filter1 select,#filter3 select,#filter5 select,#filter6 select,#filter7 select,#filter8 select,#filter9 select{
		display: none;
	}
</style>
@endsection
											...
											<table id="example1" class="table table-bordered display">
												...
												<tfoot>
													...
													<tr>
														...
														<th id="sum" style="text-align:center;font-weight:bold;font-size: 15px; color: green"> </th>
														<th> </th>
														@if(Auth::user()->status =='reseller' || Auth::user()->status =='account')
														<th> </th>
														@endif
