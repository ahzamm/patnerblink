   ...
   <section id="main-content">
      <section class="wrapper main-wrapper">
         <div class="header_view">
            <h2>Contractor & Trader Margin Report
                        ...
                        <table class="table table-bordered table-responsive" style="border: 2px #225094 solid">
                           <thead>
                              <tr style="text-align:right;font-weight:bold;font-size: 16px;"> 
                                 <th>Net Profit Margin (PKR)</th>
                                 <th>{{number_format($netProfitMargin,2)}}</th>
                              </tr>
                           </thead>
                        </table>
                     </div>
                        ...
                        <table id="example1" class="table display dt-responsive w-100">
                           <thead>
                              <tr>
                                 ...
                                 <?php  if( ($selectedUser->status == 'reseller') ){ ?>
                                    <!-- <th>Manager Rate  </th> -->
                                 <?php  } if( ($selectedUser->status == 'reseller') || ($selectedUser->status == 'dealer') ){  ?>
                                    <!-- <th>Reseller Rate  </th> -->
                                 <?php  } if( ($selectedUser->status == 'dealer') || ($selectedUser->status == 'subdealer') ){  ?>
                                    <!-- <th>Contractor Rate </th> -->
                                 <?php  } if( ($selectedUser->status == 'subdealer') ){  ?>
                                    <!-- <th>Trader Rate </th> -->
                                 <?php  } ?>
                                 <th>Profit Margin (PKR)</th>
                                 <!-- <th>Invoice</th> -->
                              </tr>
                           </thead>
                           <tbody>
                              ...
                              $card_expire = 0;
                              $user_expire = App\model\Users\UserStatusInfo::where('username' , $row['username'])->first();
                              ...
                              <tr>
                                 ...
                                 <td>{{$row['name']}}</td>
                                 <?php  if( ($selectedUser->status == 'reseller') ){ ?>
                                    <!-- <td>{{$row['manager_rate']}}</td> -->
                                 <?php  } if( ($selectedUser->status == 'reseller') || ($selectedUser->status == 'dealer') ){  ?>
                                    <!-- <td>{{$row['reseller_rate']}}</td> -->
                                 <?php  } if( ($selectedUser->status == 'dealer') || ($selectedUser->status == 'subdealer') ){  ?>
                                    <!-- <td>{{$row['dealer_rate']}}</td> -->
                                 <?php  } if( ($selectedUser->status == 'subdealer') ){  ?>
                                    <!-- <td>{{$row['subdealer_rate']}}</td> -->
                                 <?php } ?>
                                 <td style="color: #30761b;font-weight: bold;font-size: 18px;">{{$row['profitMargin']}}</td>
                              </tr>
                              @endforeach
                           </tbody>
                           <tfoot>
