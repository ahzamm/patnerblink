...
<div class="modal fade bs-example-modal-center" id="freezeLayer" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"  data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered modal-dialog modal-md">
    <div class="modal-content" style="background-color:#02020200 !important;border-color:#02020200 !important;">
     <div class="modal-body">
        ...
        <center><h1 style="color:white;">Warning ! Page already opened</h1>
          <p style="color:white;">please close the previous one to access this page. </p>
        </center>
        </div>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
