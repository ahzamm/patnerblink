...
<div aria-hidden="true"  role="dialog" tabindex="-1" id="traderfreeze" class="modal fade" style="display: none;">
        ...
        <div class="">
          <div class="row">
            <div class="" id="freezeModal">
              ...
              <form action="{{route('users.freeze.traderpost')}}" method="POST" class="form-group">
                @csrf
                <div class="">
                  <input type="hidden" name="username" id="username" >
                  <input type="hidden" name="user_status" value="subdealer" >
            ...
            <div class="" id="activeModel" style="display: none;">
              ...
              <form action="{{route('users.freeze.traderpost')}}" method="POST" class="form-group">
                ...
                <div class="pull-right">
                  <input type="submit" class="btn btn-primary" name="" id="" value="Active Now" style="background-color: red">
                  <input type="button" class="btn btn-secondary" name="" id="" value="Cancel" onclick="load()">
                </div>
              </form>
            </div>
