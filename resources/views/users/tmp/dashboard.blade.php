...
<!-- <button id="install" hidden style="top: 10px;
    position: fixed;
    left: 50%;
    z-index: 99999;
    transform: translateX(-50%);
    ...
    border-radius: 4px;
    padding-top: 4px;
    padding-bottom: 5px;"><i class="la la-mobile"></i> Install App</button> -->
          ...
          <section class="wrapper main-wrapper" style='margin:0; padding:0;'>
              <section class="home-section">
                  ...
                  <nav class="position-relative">
                    ...
                    <!-- <a href="#notif_modal" data-toggle="modal" class="drawer_modal">
                        <img src="/img/announcement.png" alt="Updates" width="140px">
                        <span>ANNOUNCEMENT</span>
                    </a> -->
                  </nav>
        ...
        <div class="container">
            <div class="card__wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <a href="<?= ($authStatus != 'manager' && $authStatus != 'reseller') ? route('users.user.onlineuser',['status' => 'user']) : "" ?>">
                            <div class="card-content">
                                <div class="icon__part">
                                    <i class="la la-users"></i>
                                </div>
                                <div class="text__part">
                                    <p><strong style="color:green" id="dashboardOnlinePercentage"><span class="dashboardLoader">loading...</span> </strong> Online Consumers</p>
                                </div>
                                <div class="count__part">
                ...
                <?php } ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <a href="<?= ($authStatus != 'manager' && $authStatus != 'reseller') ? route('users.billing.error_log') : "" ?>">
                            <div class="card-content">
                                <div class="icon__part">
                ...
                <div class="row">
                    <?php if($authStatus == 'manager'){?>
                        <div class="col-lg-<?= $col;?> col-md-4 col-sm-6 col-12">
                            <a href="{{route('users.user.index1',['status' => 'reseller'])}}">
                                <div class="card-content">
                                    <div class="icon__part">
                    ...
                    <?php } if( ($authStatus == 'manager' || $authStatus == 'reseller') && (App\MyFunctions::check_access('Contractor',Auth::user()->id)) ){?>
                        <div class="col-lg-<?= $col;?> col-md-4 col-sm-6 col-12">
                            <a href="{{route('users.user.index1',['status' => 'dealer'])}}">
                                <div class="card-content">
                                    <div class="icon__part">
                    ...
                    <?php } if( ($authStatus == 'manager' || $authStatus == 'reseller' || $authStatus == 'dealer') &&  (App\MyFunctions::check_access('Trader',Auth::user()->id))  ){
                        ...
                        <div class="col-lg-<?= $col;?> col-md-4 col-sm-6 col-12">
                            <a href="{{route('users.user.index1',['status' => 'subdealer'])}}">
                                <div class="card-content">
                                    <div class="icon__part">
                    ...
                    <?php } if( ($authStatus == 'manager' || $authStatus == 'reseller' || $authStatus == 'dealer') && App\MyFunctions::check_access('Trader',Auth::user()->id) && App\MyFunctions::check_access('Sub Trader',Auth::user()->id) ) {?>
                        <div class="col-lg-<?= $col;?> col-md-4 col-sm-6 col-12">
                            <a href="{{route('users.user.index1',['status' => 'trader'])}}">
                                <div class="card-content">
                                    <div class="icon__part">
