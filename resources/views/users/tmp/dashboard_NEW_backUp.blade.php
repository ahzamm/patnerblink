...
<li a href=""><i class="fa-solid fa-house-user"></i></a></li>
        ...
        <section class="box-section">
           <div class="container"> 
            <div class="box1">
                ...
                <div class="amount">
                    <h4 class="sec-one">All Subscribers</h4>
                    <h3 class="sec-two">
            ...
            <div class="box2">
                ...
                <div class="amount">
                    <h4 class="sec-one">Contractor</h4>
                    <h3 class="sec-two">
   ...
   <div class="box4">
    <div class="icon-box"><i class="fa fa-users"></i></div>
    <div class="amount">
        <h4 class="sec-one">Active Subscribers</h4>
        <h3 class="sec-two">{{$userStatus}}</h3>
    </div>
    <div class="hrr">
        <div class="border"></div>
    </div>
...
<section class="box-section">
   <div class="container"> 
    <div class="box1">
        <div class="icon-box2"><i class="fas fa-user-times"></i></div>
        <div class="amount2">
            <h4 id="sec-h4">
      ...
      <div class="box2">
        <div class="icon-box2"><i class="fas fa-user-slash"></i></div>
        <div class="amount2">
          ...
          <div class="border"></div>
          <h3 id="sec-head">Disable Subscribers
          </h3>
      </div>
  </div>
  <div class="box3">
    <div class="icon-box2"><i class="fas fa-user-minus"></i></div>
    <div class="amount2">
        ...
        @endif
        <div class="border"></div>
        <h3 id="sec-head">Upcoming Expiries
        </h3>
    </div>
</div>
<div class="box4">
    <div class="icon-box2"><i class="fas fa-user-check"></i></div>
    <div class="amount2">
        <h4 id="sec-h4">{{$verified_users}}</h4>
        <div class="border"></div>
        <h3 id="sec-head">CNIC verified
        </h3>
    </div>
</div>
...
<section class="box-section">
    <div class="container">
        <div class="box5">
            <div class="icon-box3"><i class="fas fa-signal"></i></div>
            <div class="amount3">
               @php
           ...
           @endphp
           <h4 id="sec-h43">{{$onlineUserr}} Online Subscribers</h4>
