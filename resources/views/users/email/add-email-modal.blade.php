    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <div class="" id="tblData">
          ...
          <div class="">
            <form id="" action="{{route('admin.post.email')}}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group position-relative">
                    ...
                    <span class="helping-mark" onmouseenter="popup_function(this, 'city_name_admin_side');" onmouseleave="popover_dismiss();"><i class="fa fa-question"></i></span>
                    <input type="text" value="" name="title" class="form-control" id="" placeholder="Example : Karachi" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group position-relative">
                    ...
                    <span class="helping-mark" onmouseenter="popup_function(this, 'city_name_admin_side');" onmouseleave="popover_dismiss();"><i class="fa fa-question"></i></span>
                    <input type="number" value="" name="port" class="form-control" id="" placeholder="Example : Karachi" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group position-relative">
                    ...
                    <span class="helping-mark" onmouseenter="popup_function(this, 'city_name_admin_side');" onmouseleave="popover_dismiss();"><i class="fa fa-question"></i></span>
                    <input type="text" value="" name="email" class="form-control" id="" placeholder="Example : Karachi" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group position-relative">
                    ...
                    <span class="helping-mark" onmouseenter="popup_function(this, 'city_name_admin_side');" onmouseleave="popover_dismiss();"><i class="fa fa-question"></i></span>
                    <input type="password" value="" name="password" class="form-control" id="" placeholder="Example : Karachi" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group position-relative">
                    ...
                    <span class="helping-mark" onmouseenter="popup_function(this, 'city_name_admin_side');" onmouseleave="popover_dismiss();"><i class="fa fa-question"></i></span>
                    <input type="text" value="" name="host" class="form-control" id="" placeholder="Example : Karachi" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group position-relative">
