    ...
    <section id="main-content" class=" ">
        <section class="wrapper main-wrapper row">
            ...
            <div class="header_view">
                <h2>Bulk Consumers (IDs) Migrate
                    <span class="info-mark" onmouseenter="popup_function(this, 'bulk_consumer_migrate_admin_side');" onmouseleave="popover_dismiss();"><i class="las la-info-circle"></i></span>
                </h2>
            </div>
                    ...
                    <div class="card-body" style="padding-top: 20px">
                        ...
                        <div class="alert alert-success alert-block">
                            ...
                            <div class="alert alert-danger alert-block">
                                ...
                                @endif
                                <form action="{{route('admin.csv.shift_user_store')}}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <button type="button" class="btn btn-default ml-4"><a
                                            href="{{asset('sample-user.csv')}}"><span class="fa fa-download"></span>
                            ...
                            <div style="padding: 2px 5px 5px 20px">
                                ...
                                <ul style="padding-inline-start: 20px">
                                    ...
                                    <li>File must contain only <b>1</b> columns.</li>
