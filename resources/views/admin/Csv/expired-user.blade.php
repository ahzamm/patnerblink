    ...
    <section id="main-content" class=" ">
        <section class="wrapper main-wrapper row">
            <div class="header_view">
                <h2>Bulk Consumers (IDs) Active & Refill
                    <span class="info-mark" onmouseenter="popup_function(this, 'bulk_consumer_active_admin_side');" onmouseleave="popover_dismiss();"><i class="las la-info-circle"></i></span>
                </h2>
            </div>
            <div class="row justify-content-center">
                <div class="card bg-white">
                    <div class="card-body" style="padding-top: 20px">
                        ...
                        @endif
                        <form action="{{ route('admin.csv.expired.user') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <br>
                                    <input type="submit" class="btn btn-primary btn-submit ml-4" name="submit" value="Submit" id="btn-submit"><button type="button"class="btn btn-default" style="margin-left: 4px;"><a href="{{asset('active.sample.csv')}}"><span class="fa fa-download" ></span> Download Sample (.csv) File</a></a></button>
                                </div>
                            </div>
                        </form>
                        <div style="padding: 2px 5px 5px 20px">
                            ...
                            <ul style="padding-inline-start: 20px">
                                ...
                                <li>File must contain only <b>3</b> columns.</li>
                                <li>File must contain heading of column.</li>
                                <li>Expiry Date format should be like this <strong>YYYY-MM-DD</strong>.</li>
                                <li>Expiry Date should not be more than <b>30</b> days ago.</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center" style="margin-top:20px;">
                <div class="card bg-white">
                    <div class="content-body" >
                        <h3>Download Active User Sheet</h3>
                        <form action="{{ route('admin.csv.download_active_user_sheet') }}"  method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group position-relative">
                                        ...
                                        <input type="radio" name="status" value="dealer" class="" required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group position-relative">
                                        <label>Trader <span style="color: red">*</span></label>
                                        <input type="radio" name="status" value="subdealer" class="" required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group position-relative">
