 ...
 .btn:hover{
     ...
     background: transparent;
        ...
        /*html {
            ...
            body{
                background-image:url("{{asset('images/login-admin-backgroudn.jpg')}}")  !important;
            	background-size: 100%;
            	height: 100%;
     ...
     <center>
      ...
      <!-- <p id="output" style="font-size: 20px;color: red;">sdasad</p> -->
            ...
            <!-- <p id="nav">
                            ...
                            <a class="pull-right" href="../../../complete-admin/v6-1/preview/ui-register.html" title="Sign Up">Sign Up</a>
                        </p> -->
                    </div>
                </div>
            </div>
