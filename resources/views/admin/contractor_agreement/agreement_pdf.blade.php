<head>
	...
	<div class="container">
		<div class="card">
					...
					<div class="">
						...
						<div>
							<table style="width: 100%">
								<tbody>
									<tr>
										...
										<td style="width: 33%; text-align: center">
											...
											if($company_logo=="logonbroadband"){
											$logo_new="logon.png";
											$first_para="M/S Logon Broadband Pvt. Ltd";
										} 
										elseif($company_logo=="spark"){
										$logo_new="SparkLogo.png";
									...
									elseif($company_logo=="blackoptic"){
									$logo_new="Bo_Logo.png";
								...
								@endphp
								<img src="img/{{$logo_new}}" width="180px" alt="Logo" style="">
							</td>
							<td style="width: 33%"></td>
						</tr>
					</tbody>
			...
			<p><strong><u>{{ strtoupper($contractor_name) }} </u></strong>bearing CNIC/ NTN <strong><u>{{ $cnic }} , </u></strong>having its office/ presence at <strong><u> {{  strtoupper($dealer_name) }}. </u></strong>(Hereinafter referred to as “Contractor”), which expression shall be deemed to include its successors-in-interest and assigns;</p>
		...
		@endphp
		<!-- Sister Concern Companys -->
		<p><strong>AND WHEREAS </strong>the Contractor has expressed its willingness to undertake the services and abide by the terms and conditions detailed herein;</p>
