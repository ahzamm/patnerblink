	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" style="text-align: center;color: white">Admin Sub-Menu Form</h4>
			</div>
			<div class="modal-body">
				<form action="{{route('admin.Management.adminsubmenu.store')}}" method="POST" style="margin-bottom:0">
					@csrf
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<select name="menu_id" id="lorder" class="form-control" required>
									...
									@php
									$get_menus = DB::table('admin_menus')->get(['menu','id']);
									@endphp
