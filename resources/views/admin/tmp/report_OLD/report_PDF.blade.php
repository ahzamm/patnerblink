		...
		<div class="card-body">
			<div class="row mb-4">
				...
				<div class="">
					...
					<p><strong><u>{{ strtoupper($company_name) }} </u></strong>bearing CNIC/ NTN <strong><u>{{ $cnic }} , </u></strong>having its office/ presence at <strong><u> {{  strtoupper($dealer_name) }}. </u></strong>(Hereinafter referred to as “Contractor”), which expression shall be deemed to include its successors-in-interest and assigns;</p>
