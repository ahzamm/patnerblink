				...
				<div class="container-fluid">
					<div class="header-body">
						<div class="row col__padding" style="margin-top: 20px;">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">
								<div class="r4_counter db_box">
									 <i class='pull-left fas fa-hands-helping icon-md icon-rounded icon-primary'></i>
									<div class="" style="text-align: center;">
										<h3><strong>
							...
							<div class="col-lg-3 col-md-6 col-sm-12">
								<div class="r4_counter db_box">
									 <i class='pull-left fas fa-handshake icon-md icon-rounded icon-primary'></i>
									<div class="" style="text-align: center;">
										<h3><strong>
											@php
												$dealer ='';
								...
								<div class="r4_counter db_box">
									...
									<div class="" style="text-align: center;">
										<h3><strong>
											...
											{{$user}}</strong></h3>
										<span>Total Number of Consumers</span>
									</div>
								</div>
							</div>
							<!-- 6ht -->
							<div class="col-lg-3 col-md-6 col-sm-12">
								<div class="r4_counter db_box">
									 <i class='pull-left fas fa-user-check icon-md icon-rounded icon-primary'></i>
									<div class="" style="text-align: center;">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">
								<div class="r4_counter db_box">
									<i class='pull-left fas fa-user-slash icon-md icon-rounded icon-accent'></i>
							...
							<div class="col-lg-3 col-md-6 col-sm-12">
								<div class="r4_counter db_box">
									...
									<div class="stats" style="text-align: center;">
										...
										<span>Upcoming Expire Consumers</span>
									</div>
								</div>
							</div>
							@endif
			...
			<div class="">
				<div class="row">
					<div class="col-md-12">
                			...
                			<div class="consumer_wrapper" style="outline: 1px solid;outline-offset: 5px;">
                    			<div class="card-content">
									...
									<div class="subscriber-count">
										<div>
											<h4 id="sec-h43" class="online_user-count text-center" style="font-size: 50px">60</h4>
						...
						<hr style="border-top:1px solid #999; margin-top: 30px">
						<!-- Table Profile -->
