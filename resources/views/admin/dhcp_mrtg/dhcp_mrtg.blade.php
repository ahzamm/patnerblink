        ...
        <div class="col-xs-12">
          ...
          <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
              <div class="" >
                <table id="example-2" class="table table-bordered table-hover dt-responsive w-100 display">
                  <thead>
                    <tr>
                      <th>Contractor (ID)</th>
                      <th>Graph Port (ID)</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th class="td__profileName">{{$cacti->user_id}}</th>
                      ...
                      <td>
                        <button class="btn btn-primary btn-xs show-graph-modal mb-5" data-id="{{$cacti->id}}" data-cat="cacti" data-toggle="modal">
                          ...
                          <a class="btn btn-danger btn-xs deleteit mb-5" data-id="{{$cacti->id}}" data-cat="cacti"><i class="fa fa-trash"></i> Delete</a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
              ...
              <div id="dhcp" class="tab-pane">
                <div class="table-responsive">
                  <table id="example-1" class="table table-bordered table-hover dt-responsive w-100 display">
                    <thead>
                      <tr>
                        <th>Contractor (ID)</th>
                    ...
                    <tbody>
                      ...
                      @endphp
                      <tr>
                        <th class="td__profileName">{{$item->dealerid}}</th>
    ...
    $('#dealers').on('change', function () {
      ...
      $.ajax({
        ...
        success: function (result) {
          $('#subdealers').html('<option value="">--- Select Trader ---</option>');
          $.each(result.subdealer, function (key, value) {
            $("#subdealers").append('<option value="' + value
...
<script>
  $(document).ready(function() {
    $(document).on('click','.show-graph-modal', function() {
      ...
      $.ajax({
        ...
        url: "{{route('admin.show_mrtg_graph')}}",
        success: function(result) {
