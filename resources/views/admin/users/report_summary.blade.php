								...
								<div class="form-group">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										...
										<label class="btn btn-secondary">
											...
											<div class="row">
											<form action="{{route('admin.users.billingReport_PDF')}}" method="POST">
													@csrf
													<div class="col-md-5">
														<div class="form-group">
													...
													<div class="col-md-5">
														<div class="form-group">
															...
															<select class="form-control" id="username-select" name="username" required >
																...
																<option value="{{$data->manager_id}}">{{$data->manager_id}}</option>
																@endforeach
										...
										@if($isSearched)
												...
												<div class="col-md-12" >
													<div style="border: 2px #225094 solid; overflow-x: auto;">
														<div>
															<h3 style="color:white;background:#225094;height: 40px; margin-top: 0px;  padding-top: 7px;font-size: 18px;font-weight: bold; text-align: center;"> Monthly Billing Report

															</h3>

															<a href="{{route('admin.users.myPDF')}}" target="_blank" class="btn btn-success mb-2" style="float: right;">Export PDF</a>
														</div>
