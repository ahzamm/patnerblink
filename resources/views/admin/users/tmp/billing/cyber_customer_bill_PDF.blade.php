...
<div class="row"> 
	<div class="div">
		...
		<div class="box">
			...
			<div class="box">
			<br> 
			<img src="{{asset('images/newCyberX.png')}}" width="30%" style="float: right;">
			Issued By :<br>
			** Advance Income tax as per Income Tax Ordinance, 2001.<br><br>
			<span style="float:right;text-align:right;">Service Sales Tax/NTN No. 0660563-0</span>
			 
			<br>

		</div>
		<div class="box" style="background-color: #fc8505">
			<center style="color:white;">Services provided by CyberXtreme, powered by Cybernet</center>
		</div>
	</div>
	<!--  -->
	<div class="div" style="margin-left: 500px;">
		...
		<div class="box">
			1) Subscription fees, usage charges and other fees for the Service will be as stated in CyberXtreme tariff information, which is subject to change from time to time. User shall pay the monthly service charges in accordance with the Subscription Plan.<br>
...
5) User acknowledge to use the service in compliance with the applicable laws, rules and regulations including but not limited to those prescribed by Pakistan Telecommunication Authority. CyberXtreme reserve the right to suspend or terminate in case of any non-compliance identified.<br>

6) User shall abide by the generally accepted standards of conduct and usage of the Service by not sending any message or material that is defamatory, invasive of privacy, obscene or offensive, or which contains viruses, worms and or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of the any software or hardware, or of CyberXtreme's network.<br>

7) User shall not resell or re-distribute the service, whether temporary or permanent or for no value.<br>

8) CyberXtreme reserves the right at any time and without assigning any reasons to terminate this service.<br>

9) All packages are subject to Fair Usage Policy (FUP), CyberXtreme reserves the right to suspend or downgrade the connection if it does not comply with FUP.<br>

10) Dealer will be responsible in case of any misuse / fraud.<br>

11) This receipt is valid for services provided by CyberXtreme exclusively and will be considered as null and void if used for any other services and/or purpose.
