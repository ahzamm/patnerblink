                ...
                <div class="">
                    <div class="">
                        <div class="header_view">
                            <h2>Contractors
                                <span class="info-mark" onmouseenter="popup_function(this, 'contractor_admin_side');" onmouseleave="popover_dismiss();"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dealerCollection as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->dealerid }}</td>
                                            <td>{{ App\model\Users\UserInfo::where(['status' => 'subdealer', 'resellerid' => $data->resellerid, 'dealerid' => $data->dealerid])->count() }}
                                            </td>
                                            <td>{{ $userCount }}</td>
                                            <td>
                                                <center><a href="{{ route('admin.user.show', ['status' => 'dealer', 'id' => $data->id]) }}">
                                                    ...
                                                    <a href="{{ route('admin.my.sheetdealerdownload', ['managerid' => $data->manager_id, 'dealerid' => $data->dealerid]) }}">
                                                        <button class="btn btn-success btn-xs" style="margin-top:4px;margin-bottom:4px"><i class="fa fa-download"></i>
                                                            Download (CSV) </button>
                                                    </a>
                                                </center>
                                            </td>
