...
use App\Http\Controllers\Users\BillRegisterController;
try {
...
Route::group(['prefix'=>'admin'],function(){
  Route::post('graph-single-refresh', 'Users\GraphController@graph_refresh')->name('admin.show_mrtg_graph');
  Route::get('get_mrtg_graph/{id}', 'Users\GraphController@get_mrtg_graph')->name('admin.get_mrtg_graph');
...
/// Email ///
   Route::get('email', 'Users\EmailController@index')->name('users.email');
   Route::get('edit/email/{id?}', 'Users\EmailController@edit')->name('users.email.edit');
   Route::post('add/email', 'Users\EmailController@store')->name('admin.post.email');
   Route::post('update/email/{id?}', 'Users\EmailController@update')->name('admin.update.email');
   Route::get('delete/email/{id?}', 'Users\EmailController@destroy')->name('email.delete');
   ...
   Route::post('/getcurrent-balance','Users\ReportController@current_balance_download_csv')->name('users.billing.current_balance');
    ...
    Route::get('/partner_profit_margin_report','Users\ReportController@partner_profit_margin_report')->name('user.users.partner_profit_margin_report');
    Route::post('/partner_profit_margin_report_action','Users\ReportController@partner_profit_margin_report_action')->name('user.users.ppm_action');
    ...
    Route::post('/charge/bulk','Users\RechargeController@bulkRecharge')->name('users.charge.bulk.post');
  ...
  Route::get('/complaint','complain\ComplainController@index')->name('users.complain');
    ...
    /// PTA Bill Register ///
    Route::get('/pta/bill-register','Users\BillRegisterController@index')->name('user.bill-register');
    Route::post('/pta/bill-register-get-data','Users\BillRegisterController@get_bill_register_data')->name('user.bill-register.get-data');
    Route::post('/pta/bill-register-update-data','Users\BillRegisterController@bill_register_update_data')->name('user.bill-register.update-data');
    Route::get('/pta/bill-register-download_sheet',[BillRegisterController::class,'download_sheet'])->name('user.bill-register.download_sheets');
     ...
     ///////
     Route::post('manager_support_transfer_amount','Users\BillingController@manager_support_transfer_amount')->name('users.manager.support.transfer_amount');
     Route::post('manager_support_receive_amount','Users\BillingController@manager_support_receive_amount')->name('users.manager.support.receive_amount');
