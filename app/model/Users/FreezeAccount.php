...
class FreezeAccount extends Authenticatable
{
    //
    use Notifiable;

    protected $table = "freeze_account";
    /**
     ...
     */
    protected $fillable = [
        'id','dealerid','status','freeze','manager_id','username','subdealerid','freezeDate','old_freeze','resellerid','freezed_by'
    ];
...
//	}	
	...
	public function dealer_profile_wise_expired_users($profileGroupname){
		...
		$instance = $instance->where([['status', '=' ,'user'],['profile','!=','DISABLED'],['profile','!=','NEW'],['profile','!=','EXPIRED']]);
	...
	// public function user_status_info_expired1(){
 //       $instance =  $this->hasOne(UserStatusInfo::class,'username','username'); // class, fk,pk
