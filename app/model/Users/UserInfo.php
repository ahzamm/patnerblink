...
class UserInfo extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'id','username','domainID','password', 'firstname', 'lastname', 'mac_address', 'email', 'nic', 'passport', 'overseas_cnic', 'homephone', 'mobilephone', 'address', 'creationdate', 'creationby', 'creationbyip', 'dealerid', 'sub_dealer_id', 'resellerid', 'manager_id', 'status', 'profile', 'area', 'disabled', 'active','disabled_old_profile', 'disabled_expired', 'disabled_date','qt_total','qt_used', 'verified','never_expire','account_disabled'
    ];
