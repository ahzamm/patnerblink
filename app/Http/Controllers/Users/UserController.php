...
class UserController extends Controller
{
    ...
    public function epiredUser($status)
    {
        ...
        //
        if ($status == "dealer") {
            $allusers = UserInfo::leftJoin("user_status_info", function ($join) {
                $join->on(
                    "user_status_info.username",
                    "=",
                    "user_info.username"
...
// saving in redCheck: entry - 3
                ...
                DB::transaction(function () use ($useripstatus, $radusergroup, $userusualIPs, $radreply, $RadCheck, $RadCheck2, $RadCheck3, $userAmount) {
                    $radreply->save();
                    $useripstatus->save();
                    $radusergroup->save();
                    $userusualIPs->save();
...
// saving in redCheck: entry - 3
                ...
                DB::transaction(function () use ($useripstatus, $radusergroup, $userusualIPs, $radreply, $RadCheck, $RadCheck2, $RadCheck3, $graph, $userAmount) {
                    $radreply->save();
                    $useripstatus->save();
                    $radusergroup->save();
                    $userusualIPs->save();
...
// saving in redCheck: entry - 3
                ...
                DB::transaction(function () use ($radusergroup, $RadCheck, $RadCheck2, $RadCheck3, $graph, $userAmount) {
                    $radusergroup->save();
...
// saving in redCheck: entry - 3
                ...
                DB::transaction(function () use ($UserStatusInfo, $radusergroup, $RadCheck, $RadCheck2, $RadCheck3, $userExpire) {
                    $UserStatusInfo->save();
                    $radusergroup->save();
