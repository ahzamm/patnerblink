...
public function index(){
    $data = UserInfo::where('active',0)->where('resellerid','logonbroadband')->whereNotIn('status',['user','inhouse'])->get();
...
{
    $data = UserInfo::where('active',0)->where('resellerid','logonbroadband')->whereNotIn('status',['user','inhouse'])->count();
